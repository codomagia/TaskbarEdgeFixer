...
Небольшая фоновая утилита для Windows, исправляющая ситуацию, когда автоматически
скрываемая панель задач не появляется при подведении курсора к нижнему краю
экрана.

Проблема особенно часто проявляется поверх развёрнутых окон браузеров, включая
Google Chrome. Taskbar Edge Fixer отслеживает нижний край экрана и аккуратно
помогает панели задач появиться, не открывая меню «Пуск» и не забирая фокус у
текущего приложения.
